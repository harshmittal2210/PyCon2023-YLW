    ...
    for event in pygame.event.get():
        if event.type == pygame.QUIT:
            ...
            while run:
                ...
                #    break
                # dino.dino_rect.right          obstacle.rect.right
                # dino.dino_rect.left           obstacle.rect.left
                # dino.dino_rect.top            obstacle.rect.top
                # dino.dino_rect.bottom         obstacle.rect.bottom
